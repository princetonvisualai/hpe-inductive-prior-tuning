...
from models.model_baseline import Model as model1
from models.model_mse_twostepwarp import Model as model2

POSTFIX1 = "baseline"
POSTFIX2 = "mse_natural_flipaugment_twostepwarp"
...
for i in range(DATASET_LENGTH):
    ...
    ######## COLLECT body part length proportions
...
torch.save(var2_collection, VAR_DIR + POSTFIX2 + ".pt")