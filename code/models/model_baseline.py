...
from utils.losses import compute_anchor_loss, compute_boundary_loss, _l1_loss
...
class Model:
    ...
    def train_step(self, frame1, frame2, return_imgs=False, predict=False):
        ...
        loss = recon_perceptual_loss + self.lambda1 * anchor_loss + self.lambda2 * boundary_loss
        ...
        d = {'anchor_loss': anchor_loss, 'boundary_loss': boundary_loss, 'recon_loss': recon_perceptual_loss}
